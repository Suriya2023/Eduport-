{/* <script> */}
                function MyonHindddenshow(){
                    // var x = document.getElementById("hidenshow");
                ...
                function MyonHindddenshowWEbtwo(){
                    // var x = document.getElementById("hidenshow");
                    // if (x.style.display="block") {
                    //             x.style.display="none"
                    // } else {
                ...
                function MyonHindddenshowWEbthird(){
                    // var x = document.getElementById("hidenshow");
                    // if (x.style.display="block") {
                    //             x.style.display="none"
                    // } else {
                ...
                function MyonHindddenshowWEbthirdforth(){
                    // var x = document.getElementById("hidenshow");
                    // if (x.style.display="block") {
                    //             x.style.display="none"
                    // } else {
